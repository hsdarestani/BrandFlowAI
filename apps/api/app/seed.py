...
admin=user('admin@smarbiz.sbs','Super Admin',True); owner=user('owner@demo.com','Demo Owner'); approver=user('client@demo.com','Client Approver')
...
db.commit(); print('Seeded Smarbiz demo data. Demo password: password123')
